...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const addQuote = () => {
        ...
        if (text === "" || category === "") {
            // Replaced alert with a simple text notification.
            displayStatus("Please enter both a quote and a category.");
            return;
        }
        ...
        fileReader.onload = (event) => {
            try {
                ...
                if (Array.isArray(importedQuotes)) {
                    ...
                    filterQuotes();
                    displayStatus('Quotes imported successfully!');
                } else {
                    displayStatus('Invalid JSON format. Please upload a file with an array of quotes.');
                }
            } catch (error) {
                displayStatus('Error parsing JSON file. Please ensure it is a valid JSON format.');
            }
        };
